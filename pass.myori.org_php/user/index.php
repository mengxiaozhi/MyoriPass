...
require '../partial/header.php';
    ...
    $qrCodeUrl = "https://chart.apis.google.com/chart?chs=300x300&cht=qr&chl=" . $qrContent;
    ...
    echo '<h1>',$displayedName ,'，', $greeting ,'<br>歡迎回來</h1>';
?>

<h3 class="title-section">個人識別碼 QR-ID</h3>
<div style="display:flex;justify-content:center;">
    <img src="<?php echo $qrCodeUrl; ?>" alt="QR-ID">
</div>
<p style="display:flex;justify-content:center;">國籍：<?php echo $user['countries']; ?></p>
