<template>
  ...
  <div id="su44dc5n3pq" class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
    <a href="https://mhlw.myori.org" target="_blank">
      <div class="rounded-lg border bg-card text-card-foreground shadow-sm w-full" data-v0-t="card">
        <div class="p-6">
          ...
          <p class="text-center">Covid-19電子確診證明</p>
        </div>
      </div>
    </a>
    <div class="rounded-lg border bg-card text-card-foreground shadow-sm w-full" data-v0-t="card">
    ...
    <div class="rounded-lg border bg-card text-card-foreground shadow-sm w-full" data-v0-t="card">
      <div class="p-6">
        ...
        <p class="text-center">稅費<br>（暫未開放）</p>
      </div>
    </div>
    <div class="rounded-lg border bg-card text-card-foreground shadow-sm w-full" data-v0-t="card">
      <div class="p-6">
        ...
        <p class="text-center">防災手册<br>（暫未開放）</p>
      </div>
    </div>
  </div>
</template>
